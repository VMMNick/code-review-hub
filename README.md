...
Перевірено відтворенням: піднято бекенд без Redis і протримано живим 25+ секунд (вихідний крах стався за ~11с) — `/health` продовжував відповідати `200`, процес не впав.
